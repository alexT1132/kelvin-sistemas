...
import ParticlesBackground from "../../components/web/ParticlesBackground";
...
export default function LoginResponsive() {
  ...
  return (
    <>
      <Topbar />
      <div className="relative min-h-[calc(92dvh-0px)] w-full bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 overflow-none">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-start gap-1 sm:gap-2 py-2 sm:py-3 pt-2 sm:pt-3 lg:pt-4">
